    ...
    with open("/proc/zoneinfo", "r") as f:
        ...
        for line in f:
            ...
            if line.startswith("Node"):
                ...
                promo_value = int(line.split()[1])
                set_value(water_mark[(node_id, zone_name)], "promo", promo_value)
...
if __name__ == "__main__":
    ...
    print("{:<6} {:<10} {:>16} {:>16} {:>16} {:>16} {:>16} {:>16}".format(
        "Node", "Zone", f"min({unit.upper()})", f"low({unit.upper()})", f"high({unit.upper()})", f"promo({unit.upper()})", f"free({unit.upper()})", f"managed({unit.upper()})"
    ))
    print("-" * 100)
    for (node_id, zone_name), values in water_mark.items():
        print("{:<6} {:<10} {:>16} {:>16} {:>16} {:>16} {:>16} {:>16}".format(
            ...
            format_value(values["promo"], unit),
