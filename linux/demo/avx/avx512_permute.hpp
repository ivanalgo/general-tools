...
// Register tests
#ifdef REGISTER_TEST
using AVX512_PERMUTE_INT = AVX512_PERMUTE<int>;
REGISTER_TEST(AVX512_PERMUTE_INT)
using AVX512_PERMUTE_FLOAT = AVX512_PERMUTE<float>;
REGISTER_TEST(AVX512_PERMUTE_FLOAT)
using AVX512_PERMUTE_DOUBLE = AVX512_PERMUTE<double>;
REGISTER_TEST(AVX512_PERMUTE_DOUBLE)
#endif
