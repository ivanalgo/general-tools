...
// Register tests
#ifdef REGISTER_TEST
using AVX2_PERMUTE_SHUFFLE_0123_INT = AVX2_PERMUTE::SHUFFLE_0123<int>;
REGISTER_TEST(AVX2_PERMUTE_SHUFFLE_0123_INT)
using AVX2_PERMUTE_UNPACKLO_INT = AVX2_PERMUTE::UNPACKLO<int>;
REGISTER_TEST(AVX2_PERMUTE_UNPACKLO_INT)
using AVX2_PERMUTE_UNPACKHI_INT = AVX2_PERMUTE::UNPACKHI<int>;
REGISTER_TEST(AVX2_PERMUTE_UNPACKHI_INT)
using AVX2_PERMUTE_SWAP_LANES_INT = AVX2_PERMUTE::SWAP_LANES<int>;
REGISTER_TEST(AVX2_PERMUTE_SWAP_LANES_INT)
using AVX2_PERMUTE_PERMUTEVAR_INT = AVX2_PERMUTE::PERMUTEVAR<int>;
REGISTER_TEST(AVX2_PERMUTE_PERMUTEVAR_INT)
#endif
