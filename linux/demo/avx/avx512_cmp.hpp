...
// Register tests
#ifdef REGISTER_TEST
using AVX512_CMP_INT = AVX512_CMP<int>;
REGISTER_TEST(AVX512_CMP_INT)
using AVX512_CMP_FLOAT = AVX512_CMP<float>;
REGISTER_TEST(AVX512_CMP_FLOAT)
using AVX512_CMP_DOUBLE = AVX512_CMP<double>;
REGISTER_TEST(AVX512_CMP_DOUBLE)
#endif
