...
struct AVX2_MINMAX {
    ...
    static constexpr const char* CLASS_TYPE = "minmax";
...
// Register tests
#ifdef REGISTER_TEST
using AVX2_MINMAX_INT = AVX2_MINMAX<int>;
REGISTER_TEST(AVX2_MINMAX_INT)
using AVX2_MINMAX_FLOAT = AVX2_MINMAX<float>;
REGISTER_TEST(AVX2_MINMAX_FLOAT)
using AVX2_MINMAX_DOUBLE = AVX2_MINMAX<double>;
REGISTER_TEST(AVX2_MINMAX_DOUBLE)
#endif
