...
// Register tests
#ifdef REGISTER_TEST
using AVX512_BITWISE_INT = AVX512_BITWISE<int>;
REGISTER_TEST(AVX512_BITWISE_INT)
using AVX512_BITWISE_FLOAT = AVX512_BITWISE<float>;
REGISTER_TEST(AVX512_BITWISE_FLOAT)
using AVX512_BITWISE_DOUBLE = AVX512_BITWISE<double>;
REGISTER_TEST(AVX512_BITWISE_DOUBLE)
#endif
