...
// Register tests
#ifdef REGISTER_TEST
using AVX512_REDUCE_INT = AVX512_REDUCE<int>;
REGISTER_TEST(AVX512_REDUCE_INT)
using AVX512_REDUCE_FLOAT = AVX512_REDUCE<float>;
REGISTER_TEST(AVX512_REDUCE_FLOAT)
using AVX512_REDUCE_DOUBLE = AVX512_REDUCE<double>;
REGISTER_TEST(AVX512_REDUCE_DOUBLE)
#endif
