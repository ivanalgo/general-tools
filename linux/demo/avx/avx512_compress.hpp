...
// Register tests
#ifdef REGISTER_TEST
using AVX512_COMPRESS_INT = AVX512_COMPRESS<int>;
REGISTER_TEST(AVX512_COMPRESS_INT)
using AVX512_COMPRESS_FLOAT = AVX512_COMPRESS<float>;
REGISTER_TEST(AVX512_COMPRESS_FLOAT)
using AVX512_COMPRESS_DOUBLE = AVX512_COMPRESS<double>;
REGISTER_TEST(AVX512_COMPRESS_DOUBLE)
#endif
